            ...
            <form action="<?= base_url('admin/user/update') ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    ...
                    <div class="col-span-12">
                        <label class="form-label"><P>Nama</P></label>
            ...
            <form action="<?= base_url('admin/user/simpan') ?>" method="post" enctype="multipart/form-data">
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12">
                        ...
                        <input name="nama" id="modal-form-nama" type="text" class="form-control" placeholder="Nama Produk" required>
                    </div>
					<div class="col-span-12">
                        <label class="form-label">Username</label>
                        <input name="username" id="modal-form-keterangan" type="text" class="form-control" required>
                    </div>
					<div class="col-span-12">
                        <label class="form-label">Password</label>
                        <input name="password" id="modal-form-keterangan" type="text" class="form-control" required>
                    </div>
					<div class="col-span-12">
